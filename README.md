...
发布包使用本地 ad-hoc 签名，不需要 Apple Developer 账号，也不会提交 Apple 公证。直接从 GitHub 下载后，macOS 可能提示无法验证开发者；首次启动时请在 Finder 中右键应用并选择“打开”，或前往“系统设置 → 隐私与安全性”允许打开。

Release 同时提供 SHA-256 校验文件，可用于核对下载内容是否完整。
